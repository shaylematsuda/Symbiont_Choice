...
```{r}
ALL_27_9000_plot<-ggplot(data=ALL_27_9000_mean, aes(x=Day, y=mean, group = Symbiont, color=Symbiont)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("Cells/Larvae"))) +
  ggtitle("Multi-infection average infection per larvae, 9000")+
  theme(plot.title = element_text(size=20, face = "italic"));ALL_27_9000_plot
```

High 30C
```{r}
ALL_30_mean <- ddply(ALL_30_9000, c("Day", "Temp","Symbiont"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
```{r}
ALL_30_plot<-ggplot(data=ALL_30_mean, aes(x=Day, y=mean, group = Symbiont, color=Symbiont)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Symbiont), size=4, show.legend = T)+
  geom_line(aes(color=Symbiont))+
...
High 31C
```{r}
ALL_31_mean <- ddply(ALL_31_9000, c("Day", "Temp","Symbiont"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
```{r}
ALL_31_plot<-ggplot(data=ALL_31_mean, aes(x=Day, y=mean, group = Symbiont, color=Symbiont)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Symbiont), size=4, show.legend = T)+
  geom_line(aes(color=Symbiont))+
...
27C Day 3
```{r}
ALL_27_Day3<-subset(ALL_27_9000, Day==3)
ALL_27_Day3plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_27_Day3,
                           stat="identity");ALL_27_Day3plot
```
#Plot infection of individual larvae
27C Day 7
```{r}
ALL_27_Day7<-subset(ALL_27_9000, Day==7)
ALL_27_Day7plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_27_Day7,
...
27C Day 14
```{r}
ALL_27_Day14<-subset(ALL_27_9000, Day==14)
ALL_27_Day14plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_27_Day14,
...
30C Day 3
```{r}
ALL_30_Day3<-subset(ALL_30_9000, Day==3)
ALL_30_Day3plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day3,
                           stat="identity");ALL_30_Day3plot
```
#Plot infection of individual larvae
30C Day 7
```{r}
ALL_30_Day7<-subset(ALL_30_9000, Day==7)
ALL_30_Day7plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day7,
...
30C Day 14
```{r}
ALL_30_Day14<-subset(ALL_30_9000, Day==14)
ALL_30_Day14plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day14,
...
31C Day 3
```{r}
ALL_31_Day3<-subset(ALL_31_9000, Day==3)
ALL_31_Day3plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_31_Day3,
                           stat="identity");ALL_31_Day3plot
```
#Plot infection of individual larvae
31C Day 7
```{r}
ALL_31_Day7<-subset(ALL_31_9000, Day==7)
ALL_31_Day7plot<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_31_Day7,
