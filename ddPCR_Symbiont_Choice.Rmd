...
Data analysis of the Symbiont Choice experiment conducted at AIMS in 2018. 
...
Single-choice infection: Individual infection of single species: C1, D1, F1, and G3
4-way choice: Mix of all four species (coded as poly/polyculture)
Pot: the containers larvae were kept in (3 reps/clade/temp)
...
#make DF for Poly cell densities for COUNTS (not binomial) (ALL =Poly) for below
...
# Fig Competative-infection: Polycluture only, relative abundance of each clade - Figure 3B, Table 4, Tab S11  
