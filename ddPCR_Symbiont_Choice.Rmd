...
C1_9000b$cells.larvae_log<-log(C1_9000b$cells.larvae+1)
  hist(C1_9000b$cells.larvae_log, w=.01, breaks = 10) #more normal but not great
...
C1_9000b$cells.larvae_x2<-(C1_9000b$cells.larvae)^2 #x^2 not great
...
C1countdat$cells.larvae_log<-log10(C1countdat$cells.larvae+1)
...
hist(C1Full$cells.larvae_log, breaks=50)


#Raw means
C1Full_mean<- ddply(C1Full, c("Day", "Temp","count.type","Symbiont"), summarise, #summarize cell counts
...
# Remove rows with <3 replicates
C1Full_mean<-C1Full_mean[!(C1Full_mean$N==1),]

C1vars2<-c("Day", "Temp","count.type", "mean","Symbiont")
C1Full_means2<-C1Full_mean[C1vars2]

#Day 3 scope vs ddpcr
C1Full_means3<-subset(C1Full_means2, Day=="3")
C1Full_means3<-dcast(C1Full_means3, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()

#Day 7 and 14 scope vs ddpcr
C1Full_means4<-subset(C1Full_means2, Day=="7"|Day=="14")
C1Full_means4<-dcast(C1Full_means4, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()
...
#Raw means
D1Full_mean<- ddply(D1Full, c("Day", "Temp","count.type","Symbiont"), summarise, #summarize cell counts
...
D1vars2<-c("Day", "Temp","count.type", "mean","Symbiont")
D1Full_means2<-D1Full_mean[D1vars2]

#Day 3 scope vs ddpcr
D1Full_means3<-subset(D1Full_means2, Day=="3")
D1Full_means3<-dcast(D1Full_means3, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()

#Day 7 and 14 scope vs ddpcr
D1Full_means4<-subset(D1Full_means2, Day=="7"|Day=="14")
D1Full_means4<-dcast(D1Full_means4, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()
...
#Raw means
F1Full_mean<- ddply(F1Full, c("Day", "Temp","count.type","Symbiont"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
# Remove rows with <5 replicates
F1Full_mean<-F1Full_mean[!(F1Full_mean$N==1),]

F1vars2<-c("Day", "Temp","count.type", "mean", "Symbiont")
F1Full_means2<-F1Full_mean[F1vars2]

#Day 3 scope vs ddpcr
F1Full_means3<-subset(F1Full_means2, Day=="3")
F1Full_means3<-dcast(F1Full_means3, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()

#Day 7 and 14 scope vs ddpcr
F1Full_means4<-subset(F1Full_means2, Day=="7"|Day=="14")
F1Full_means4<-dcast(F1Full_means4, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()
...
#Raw means
G3Full_mean<- ddply(G3Full, c("Day", "Temp","count.type","Symbiont"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
G3vars2<-c("Day", "Temp","count.type", "mean","Symbiont")
G3Full_means2<-G3Full_mean[G3vars2]

#Day 3 scope vs ddpcr
G3Full_means3<-subset(G3Full_means2, Day=="3")
G3Full_means3<-dcast(G3Full_means3, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()

#Day 7 and 14 scope vs ddpcr
G3Full_means4<-subset(G3Full_means2, Day=="7"|Day=="14")
G3Full_means4<-dcast(G3Full_means4, Temp+Day+Symbiont~count.type, value.var = "mean") # cast()
...
##### not working
ScopeddPCR<-dcast(ScopeddPCR, id=c("Day", "Temp","Symbiont"), measure.vars = "ddPCR", "scope")


ggplot(ScopeddPCR, aes(x=scope, y=ddPCR, group=Symbiont))+
         geom_line()+
        geom_point()+
         scale_y_log10(breaks = c(0,1,100,1000, 10000), limits=c(1,1000))+
           scale_x_log10(breaks = c(0,1,100,1000, 10000), limits=c(1,1000))
...
ggplot(HemoddPCR, aes(x=hemo, y=ddPCR, group=count.type))+
         geom_line()+
        geom_point()+
         scale_y_log10(breaks = c(0,1,100,1000, 10000), limits=c(1,5000))+
             scale_x_log10(breaks = c(0,1,100,1000, 10000), limits=c(1,5000))


############## figure out how to color this by group. or not. put a line thorugh it all. 
