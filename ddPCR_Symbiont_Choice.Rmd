...
YOU DID THIS INSTEAD WITH A REGRESSION TABLE!
DELETE 
...
write.csv(C1Full_means2,"C1Full_means2.csv")
...
#write.csv(G3_9000b,"G3_9000b.csv")
...
testplot<-ggplot(data=D1Full_means2, aes(x=Day, y=mean, group = count.type, color=count.type)) +
  #geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                #width=0.1, show.legend = T)+
  geom_point(aes(color=count.type), size=4, show.legend = T)+ 
  geom_line(aes(color=count.type))+
  ...
  ggtitle("ddpcr vs hemo")+
  theme(plot.title = element_text(size=20));testplot
...
ScopeddPCR1$PotCode<-paste0(ScopeddPCR1$Temp, ScopeddPCR1$Pot,ScopeddPCR1$Symbiont ) #make pot code
 ScopeddPCR1$PotCode<-as.factor(ScopeddPCR1$PotCode) #make factor

ScopeddPCR_mod2<-lmer(cells.larvae_log~count.type*Symbiont+(1|PotCode), ScopeddPCR1)   
...
#by clade
ScopeddPCR1_C1<-subset(ScopeddPCR1, Symbiont=="C1")
ScopeddPCR1_C1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), ScopeddPCR1_C1)   
anova(ScopeddPCR1_C1Mod, type=2)  #not sig
qqPlot(residuals(ScopeddPCR1_C1Mod)) #ok

ScopeddPCR1_D1<-subset(ScopeddPCR1, Symbiont=="D1")
ScopeddPCR1_D1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), ScopeddPCR1_D1)   
anova(ScopeddPCR1_D1Mod, type=2)  #SIG
qqPlot(residuals(ScopeddPCR1_D1Mod)) #medium

ScopeddPCR1_F1<-subset(ScopeddPCR1, Symbiont=="F1")
ScopeddPCR1_F1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), ScopeddPCR1_F1)   
anova(ScopeddPCR1_F1Mod, type=2)  #not sig
qqPlot(residuals(ScopeddPCR1_F1Mod)) #5 outside

ScopeddPCR1_G3<-subset(ScopeddPCR1, Symbiont=="G3")
ScopeddPCR1_G3Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), ScopeddPCR1_G3)   
anova(ScopeddPCR1_G3Mod, type=2)  #not sig
qqPlot(residuals(ScopeddPCR1_G3Mod)) #good, 2 outside
...
hist(hemoPCR_D7$cells.larvae_log)
  hemoPCR_D7$PotCode<-paste0(hemoPCR_D7$Temp, hemoPCR_D7$Pot,hemoPCR_D7$Symbiont ) #make pot code
  hemoPCR_D7$PotCode<-as.factor(hemoPCR_D7$PotCode) #make factor
  hemoPCR_D7$count.type<-as.factor(hemoPCR_D7$count.type) #make factor

#FULL

hemoPCR_D7_mod2<-lmer(cells.larvae_log~count.type:Symbiont+(1|PotCode), hemoPCR_D7)   
anova(hemoPCR_D7_mod2, type=2)  # sig diff
qqPlot(residuals(hemoPCR_D7_mod2)) #good

#by clade
hemoPCR_D7_C1<-subset(hemoPCR_D7, Symbiont=="C1")
hemoPCR_D7_C1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D7_C1)   
anova(hemoPCR_D7_C1Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D7_C1Mod)) #good

hemoPCR_D7_D1<-subset(hemoPCR_D7, Symbiont=="D1")
hemoPCR_D7_D1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D7_D1)   
anova(hemoPCR_D7_D1Mod, type=2)  #SIG
hist(hemoPCR_D7_D1$cells.larvae_log)
qqPlot(residuals(hemoPCR_D7_D1Mod)) #good

hemoPCR_D7_F1<-subset(hemoPCR_D7, Symbiont=="F1")
hemoPCR_D7_F1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D7_F1)   
anova(hemoPCR_D7_F1Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D7_F1Mod)) #5 outside

hemoPCR_D7_G3<-subset(hemoPCR_D7, Symbiont=="G3")
hemoPCR_D7_G3Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D7_G3)   
anova(hemoPCR_D7_G3Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D7_G3Mod)) #good, 2 outside
...
hemoPCR_D14$PotCode<-paste0(hemoPCR_D14$Temp, hemoPCR_D14$Pot,hemoPCR_D14$Symbiont ) #make pot code
hemoPCR_D14$PotCode<-as.factor(hemoPCR_D14$PotCode) #make factor

hemoPCR_D14_mod<-lmer(cells.larvae_log~count.type*Symbiont+(1|PotCode), hemoPCR_D14)   
anova(hemoPCR_D14_mod, type=2) # sig


#by clade
hemoPCR_D14_C1<-subset(hemoPCR_D14, Symbiont=="C1")
hemoPCR_D14_C1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D14_C1)   
anova(hemoPCR_D14_C1Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D14_C1Mod)) #good

hemoPCR_D14_D1<-subset(hemoPCR_D14, Symbiont=="D1")
hemoPCR_D14_D1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D14_D1)   
anova(hemoPCR_D14_D1Mod, type=2)  #SIG
hist(hemoPCR_D14_D1$cells.larvae_log)
qqPlot(residuals(hemoPCR_D14_D1Mod)) #good

hemoPCR_D14_F1<-subset(hemoPCR_D14, Symbiont=="F1")
hemoPCR_D14_F1Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D14_F1)   
anova(hemoPCR_D14_F1Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D14_F1Mod)) #good

hemoPCR_D14_G3<-subset(hemoPCR_D14, Symbiont=="G3")
hemoPCR_D14_G3Mod<-lmer(cells.larvae_log~count.type+(1|PotCode), hemoPCR_D14_G3)   
anova(hemoPCR_D14_G3Mod, type=2)  #not sig
qqPlot(residuals(hemoPCR_D14_G3Mod)) #good
...
## the elipse plot, you don't need but good to know how
ggplot(data=scopehemo_ddPCRCompare,aes(x=Countmean, y=ddPCRmean, colour=Symbiont)) +
   geom_point(aes(colour=factor(Symbiont), shape=count.type.x)) +
   #geom_smooth(method=lm, na.rm = TRUE, fullrange= TRUE,aes(group=1),colour="black")+
   scale_colour_manual(name="condition",
       values=c("red","blue","green","orange"))+
  scale_x_continuous(trans = "log10")+
    scale_y_continuous(trans = "log10")+
  stat_ellipse(geom = "polygon", alpha = 1/4, level=0.5,aes(fill = Symbiont))+ # alpha lets you choose confidence interval
theme_classic()
...
p<-ggplot(data=scopehemo_ddPCRCompare,aes(x=Countmean_log, y=ddPCRmean_log)) +
...
theme_classic()+
 geom_abline(intercept = 0, slope = .94)+ #add in lmodel2 slope/intercept
  #geom_smooth(aes(ymin=.73, ymax=1.20))+
...
#everything
scopehemo_ddPCRCompare$Countmean_log<-log(scopehemo_ddPCRCompare$Countmean+1)
scopehemo_ddPCRCompare$ddPCRmean_log<-log(scopehemo_ddPCRCompare$ddPCRmean+1)

lm(ddPCRmean_log~Countmean_log, data = scopehemo_ddPCRCompare)

#ScopeHemo ddPCR 
scopehemo_mod<-lmodel2(ddPCRmean_log~Countmean_log, data = scopehemo_ddPCRCompare)

# y =0.94x + 0.18 to convert scope/hemo to ddPCR


#Convert Scope/hemo data, remake df with ddPCR data.
#C1
C1FullddPCR<-subset(C1Full, count.type=="ddPCR")
C1Fullscopehemo<-subset(C1Full, count.type=="hemo"|count.type=="scope")
C1Fullscopehemo$cells.larvae_log_Old<-C1Fullscopehemo$cells.larvae_log #save old
#C1Fullscopehemo$cells.larvae_unlog<-(C1Fullscopehemo$cells.larvae_log^10)-1
C1Fullscopehemo$cells.larvae_log<-(C1Fullscopehemo$cells.larvae_log*0.94)+0.18 #convert and check

C1Full<-rbind(C1FullddPCR,C1Fullscopehemo) #rebind

#D1
D1FullddPCR<-subset(D1Full, count.type=="ddPCR")
D1Fullscopehemo<-subset(D1Full, count.type=="hemo"|count.type=="scope")
#D1Fullscopehemo$cells.larvae_log_Old<-D1Fullscopehemo$cells.larvae_log #save old
D1Fullscopehemo$cells.larvae_log<-(D1Fullscopehemo$cells.larvae_log*0.94)+0.18 #convert and check

D1Full<-rbind(D1FullddPCR,D1Fullscopehemo) #rebind

#F1
F1FullddPCR<-subset(F1Full, count.type=="ddPCR")
F1Fullscopehemo<-subset(F1Full, count.type=="hemo"|count.type=="scope")
#F1Fullscopehemo$cells.larvae_log_Old<-F1Fullscopehemo$cells.larvae_log #save old
F1Fullscopehemo$cells.larvae_log<-(F1Fullscopehemo$cells.larvae_log*0.94)+0.18 #convert and check

F1Full<-rbind(F1FullddPCR,F1Fullscopehemo) #rebind


#G3
G3FullddPCR<-subset(G3Full, count.type=="ddPCR")
G3Fullscopehemo<-subset(G3Full, count.type=="hemo"|count.type=="scope")
#G3Fullscopehemo$cells.larvae_log_Old<-G3Fullscopehemo$cells.larvae_log #save old
G3Fullscopehemo$cells.larvae_log<-(G3Fullscopehemo$cells.larvae_log*0.94)+0.18 #convert and check

G3Full<-rbind(G3FullddPCR,G3Fullscopehemo) #rebind
...
CAN YOU STILL DO THIS WITH THE CORRECTION
```{r}   
...
#C1
  ...
  dispersion_glmer(Binary_C1_mod)  #no overdispersion 
    ...
    Binary_C1_mod2<-glmer(Infect~Temp*Day+(1|PotCode)+(1|count.type), family="binomial", Binary_C1)
  Anova(Binary_C1_mod2)
...
#D1
  ...
  Binary_D1_mod2<-glmer(Infect~Temp*Day+(1|PotCode)+(1|count.type), family="binomial", Binary_D1) 
  Anova(Binary_D1_mod2)
...
#F1
  ...
  Binary_F1_mod2<-glmer(Infect~Temp*Day+(1|PotCode)+(1|count.type), family="binomial", Binary_F1) 
  Anova(Binary_F1_mod2)
...
#G3
  ...
  Binary_G3mod2<-glmer(Infect~Temp*Day+(1|PotCode)+(1|count.type), family="binomial", Binary_G3) 
  Anova(Binary_G3mod2)
...
Single infections: Only data where infection happened (we use binomial to test for infection success)
```{r}   
...
anova(Single_all_mod, type=2)
qqPlot(residuals(Single_all_mod))   # good

  emm<-emmeans(Single_all_mod,  ~ Symbiont*Temp *Day, adjust="Tukey")
cld(emm)

Single_all_mod2<-lmer(cells.larvae_log~Symbiont*Day*Temp+(1|PotCode)+(1|count.type), Singles)
anova(Single_all_mod2, type=2)
...
cld(emm, Letter="abcdefg")
  ...
  C1mod2<-lmer(cells.larvae_log~Day*Temp+(1|PotCode)+(1|count.type), Singles_C1)
anova(C1mod2, type=2)
```
D1 singles    
```{r}
...
cld(emm, Letter="abcdefg")
  ...
  D1mod2<-lmer(cells.larvae_log~Day*Temp+(1|PotCode)+(1|count.type), Singles_D1)
anova(D1mod2, type=2)
```
...
cld(emm, Letter="abcdefg")
  ...
  F1mod2<-lmer(cells.larvae_log~Day*Temp+(1|PotCode)+(1|count.type), Singles_F1)
anova(F1mod2, type=2)
```
...
cld(emm, Letter="abcdefg")
  ...
  G3mod2<-lmer(cells.larvae_log~Day*Temp+(1|PotCode)+(1|count.type), Singles_G3)
anova(G3mod2, type=2)
```



Single comparision days between symbs, PLOTS
```{r}
#cool plot
...
Heat maps, by clade (temp x time)
...
col_breaks = c(seq(0,3,length=100),  # for red
  seq(3.1,6,length=100),           # for yellow
  seq(6.1,9,length=100))             # for green
...
F1heat<-heatmap.2(F1mat_data,
  cellnote = F1mat_data,  # same data set for cell labels
...
#stats
#A did larvae with single clades infect more or less than larvae offered multiple clades: 
...
#Full model including all clades: (this is testing each symbiont against eachother and against the group "All" which is did multi infection larvae infect period)
 Multi_Single_binary_model<-glmer(Infect~Temp*Symbiont*Day+(1|PotCode), family="binomial", Multi_Single_binary) #is this warning oK? Better way to run this model? For binomial i thought this is it. The error could be due to not all clades living to day 14. 
...
#combine with Each individual clade
```
combine with Each individual clade
...
C1_binary_SinMul_plot_27<-ggplot(data=C1_binary_SinMul_mean_27, aes(x=Day, y=mean, group=infectType, color=infectType)) +
  ...
  ggtitle("27C C1 single vs competition binomial")+
...
#B PLOT Multi infection, % larvae infected with 0,1, 2, 3, or 4 types (not by clade)
```{r}    
ALL_RelAvar<-c("Day", "Temp", "ALL.number","C1","D1","F1" ,"G3","PotCode","numclade")
...
#stats   CHECK THIS! you may need to transform data better!
hist(ALL_RelA_Infect$infectNum)
ALL_RelA_Infect$infectNum<-log(ALL_RelA_Infect$infectNum)
ALL_RelA_Infect_mod<-lmer(infectNum~Temp*Day+(1|PotCode), ALL_RelA_Infect) 
  anova(ALL_RelA_Infect_mod)
...
```{r}  
#subset C1 
CountsCompare_C1_indi<-subset(CountsCompare_mean_indi, Symbiont=="C1")
CountsCompare_C1_multi<-subset(CountsCompare_mean_multi, Symbiont=="C1")

#Subset 27
CountsCompare_indi_27<-subset(CountsCompare_C1_indi, Temp=="27")
CountsCompare_multi_27<-subset(CountsCompare_C1_multi, Temp=="27")

CountsCompare_C1<-rbind(CountsCompare_indi_27,CountsCompare_multi_27)

CountsCompare_C1_plot27<-ggplot(data=CountsCompare_C1, aes(x=Day, y=mean, group=single.multi, color=single.multi)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("27C C1 single vs competition")+
  theme(plot.title = element_text(size=20, face = "italic"));CountsCompare_C1_plot27

```
C1: 30C
```{r}
#Subset 30
CountsCompare_indi_30<-subset(CountsCompare_C1_indi, Temp=="30")
CountsCompare_multi_30<-subset(CountsCompare_C1_multi, Temp=="30")

CountsCompare_C1_30<-rbind(CountsCompare_indi_30,CountsCompare_multi_30)
...
CountsCompare_C1_plot30<-ggplot(data=CountsCompare_C1_30, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("30C C1 single vs competition")+
  theme(plot.title = element_text(size=20, face = "italic"));CountsCompare_C1_plot30

```
C1: 31C
```{r}
#Subset 31
CountsCompare_indi_31<-subset(CountsCompare_C1_indi, Temp=="31")
CountsCompare_multi_31<-subset(CountsCompare_C1_multi, Temp=="31")

CountsCompare_C1_31<-rbind(CountsCompare_indi_31,CountsCompare_multi_31)
...
CountsCompare_C1_plot31<-ggplot(data=CountsCompare_C1_31, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  scale_color_manual(values=c("deeppink3", "turquoise3"))+
  xlab("Days") + #Label the X Axis
      # scale_y_log10(breaks = c(-100,1,100,1000, 10000), limits=c(1,5000))+  xlab("Days") + 
  theme_bw() + #Set the background color
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        axis.title=element_text(size=14,face="bold"), #Set axis format
        panel.border = element_blank(), #Set the border
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("31C C1 single vs competition")+
  theme(plot.title = element_text(size=20, face = "italic"));CountsCompare_C1_plot31
...
```{r}
#subset D1
CountsCompare_D1_indi<-subset(CountsCompare_mean_indi, Symbiont=="D1")
CountsCompare_D1_multi<-subset(CountsCompare_mean_multi, Symbiont=="D1")

#Subset 27
CountsCompare_indi_27<-subset(CountsCompare_D1_indi, Temp=="27")
CountsCompare_multi_27<-subset(CountsCompare_D1_multi, Temp=="27")

CountsCompare_D1<-rbind(CountsCompare_indi_27,CountsCompare_multi_27)
...
CountsCompare_D1_plot27<-ggplot(data=CountsCompare_D1, aes(x=Day, y=mean, group=single.multi, color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("27C D1 single vs competition")+
...
```{r}
#Subset 30
CountsCompare_indi_30<-subset(CountsCompare_D1_indi, Temp=="30")
CountsCompare_multi_30<-subset(CountsCompare_D1_multi, Temp=="30")

CountsCompare_D1_30<-rbind(CountsCompare_indi_30,CountsCompare_multi_30)
...
CountsCompare_D1_plot30<-ggplot(data=CountsCompare_D1_30, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("30C D1 single vs competition")+
...
```{r}
#Subset 31
CountsCompare_indi_31<-subset(CountsCompare_D1_indi, Temp=="31")
CountsCompare_multi_31<-subset(CountsCompare_D1_multi, Temp=="31")

CountsCompare_D1_31<-rbind(CountsCompare_indi_31,CountsCompare_multi_31)
...
CountsCompare_D1_plot31<-ggplot(data=CountsCompare_D1_31, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("31C D1 single vs competition")+
...
```{r}
#subset F1
CountsCompare_F1_indi<-subset(CountsCompare_mean_indi, Symbiont=="F1")
CountsCompare_F1_multi<-subset(CountsCompare_mean_multi, Symbiont=="F1")

#Subset 27
CountsCompare_indi_27<-subset(CountsCompare_F1_indi, Temp=="27")
CountsCompare_multi_27<-subset(CountsCompare_F1_multi, Temp=="27")

CountsCompare_F1<-rbind(CountsCompare_indi_27,CountsCompare_multi_27)
...
CountsCompare_F1_plot27<-ggplot(data=CountsCompare_F1, aes(x=Day, y=mean, group=single.multi, color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("27C F1 single vs competition")+
...
```{r}
#Subset 30
CountsCompare_indi_30<-subset(CountsCompare_F1_indi, Temp=="30")
CountsCompare_multi_30<-subset(CountsCompare_F1_multi, Temp=="30")

CountsCompare_F1_30<-rbind(CountsCompare_indi_30,CountsCompare_multi_30)
...
CountsCompare_F1_plot30<-ggplot(data=CountsCompare_F1_30, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("30C F1 single vs competition")+
...
```{r}
#Subset 31
CountsCompare_indi_31<-subset(CountsCompare_F1_indi, Temp=="31")
CountsCompare_multi_31<-subset(CountsCompare_F1_multi, Temp=="31")

CountsCompare_F1_31<-rbind(CountsCompare_indi_31,CountsCompare_multi_31)
...
CountsCompare_F1_plot31<-ggplot(data=CountsCompare_F1_31, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("31C F1 single vs competition")+
...
```{r}
#subset G3
CountsCompare_G3_indi<-subset(CountsCompare_mean_indi, Symbiont=="G3")
CountsCompare_G3_multi<-subset(CountsCompare_mean_multi, Symbiont=="G3")

#Subset 27
CountsCompare_indi_27<-subset(CountsCompare_G3_indi, Temp=="27")
CountsCompare_multi_27<-subset(CountsCompare_G3_multi, Temp=="27")

CountsCompare_G3<-rbind(CountsCompare_indi_27,CountsCompare_multi_27)
...
CountsCompare_G3_plot27<-ggplot(data=CountsCompare_G3, aes(x=Day, y=mean, group=single.multi, color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("27C G3 single vs competition")+
...
```{r}
#Subset 30
CountsCompare_indi_30<-subset(CountsCompare_G3_indi, Temp=="30")
CountsCompare_multi_30<-subset(CountsCompare_G3_multi, Temp=="30")

CountsCompare_G3_30<-rbind(CountsCompare_indi_30,CountsCompare_multi_30)
...
CountsCompare_G3_plot30<-ggplot(data=CountsCompare_G3_30, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("30C G3 single vs competition")+
...
```{r}
#Subset 31
CountsCompare_indi_31<-subset(CountsCompare_G3_indi, Temp=="31")
CountsCompare_multi_31<-subset(CountsCompare_G3_multi, Temp=="31")

CountsCompare_G3_31<-rbind(CountsCompare_indi_31,CountsCompare_multi_31)
...
CountsCompare_G3_plot31<-ggplot(data=CountsCompare_G3_31, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("31C G3 single vs competition")+
