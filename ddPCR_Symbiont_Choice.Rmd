...
qqPlot(residuals(D3_ddPCRscope)) 
...
#ScopeddPCR_C1 REMOVED POT bc low n
ScopeddPCR_C1_D3<-lm(ddPCR~scope*Temp, ScopeddPCR_C1)   #C1
summary(ScopeddPCR_C1_D3)
plot(allEffects(ScopeddPCR_C1_D3))

ScopeddPCR_D1_D3<-lm(ddPCR~scope*Temp, ScopeddPCR_D1)   #D1
summary(ScopeddPCR_D1_D3)
plot(allEffects(ScopeddPCR_D1_D3))

ScopeddPCR_F1_D3<-lm(ddPCR~scope*Temp, ScopeddPCR_F1)   #F1
summary(ScopeddPCR_F1_D3)
plot(allEffects(ScopeddPCR_F1_D3))

ScopeddPCR_G3_D3<-lm(ddPCR~scope*Temp, ScopeddPCR_G3)   #G3
summary(ScopeddPCR_G3_D3)
plot(allEffects(ScopeddPCR_G3_D3))

# Day 7 scope vs ddCPR, the data is logged
D7_ddPCRhemo_C1<-lm(ddPCR~hemo*Temp, HemoddPCR_D7_C1)    #C1
summary(D7_ddPCRhemo_C1)

D7_ddPCRhemo_D1<-lm(ddPCR~hemo*Temp, HemoddPCR_D7_D1)    #D1
summary(D7_ddPCRhemo_D1)

D7_ddPCRhemo_F1<-lm(ddPCR~hemo*Temp, HemoddPCR_D7_F1)    #D1
summary(D7_ddPCRhemo_F1)

D7_ddPCRhemo_G3<-lm(ddPCR~hemo*Temp, HemoddPCR_D7_G3)    #G3
summary(D7_ddPCRhemo_G3)

# Day 14 scope vs ddCPR, the data is logged   

D14_ddPCRhemo_C1<-lm(ddPCR~hemo*Temp, HemoddPCR_D14_C1)   #C1
summary(D14_ddPCRhemo_C1)

D14_ddPCRhemo_D1<-lm(ddPCR~hemo*Temp, HemoddPCR_D14_D1)   #D1
summary(D14_ddPCRhemo_D1)

D14_ddPCRhemo_F1<-lm(ddPCR~hemo*Temp, HemoddPCR_D14_F1)   #F1
summary(D14_ddPCRhemo_F1)

D14_ddPCRhemo_G3<-lm(ddPCR~hemo*Temp, HemoddPCR_D14_G3)   #G3
summary(D14_ddPCRhemo_G3)
```
