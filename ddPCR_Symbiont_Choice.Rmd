...
#False pos, if Pos dropletees not above threshold, change to 0

C1_9000$Positives[C1_9000$Positives<9] <- 0
D1_9000$Positives[D1_9000$Positives<9] <- 0
F1_9000$Positives[F1_9000$Positives<11] <- 0
G3_9000$Positives[G3_9000$Positives<11] <- 0
...
#ALL Plot infection of individual larvae, multi-infection
ALL 27C Day 3, stacked bars individuals
```{r}
...
ALL_27_Day14plot_9000<-ALL_27_Day14plot_9000+ theme(legend.position = "none") #remove legend
...
ALL_30_Day3plot_9000<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day3_9000,
                           stat="identity")+
   ylim(0,11000)+
  ggtitle("Day 3, 30C");ALL_30_Day3plot_9000
```
...
ALL_30_Day7plot_9000<-ggplot() +  
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day7_9000,
                           stat="identity")+
 ylim(0,11000)+
  ggtitle("Day 7, 30C");ALL_30_Day7plot_9000
```
...
ALL_30_Day14plot_9000<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_30_Day14_9000,
                           stat="identity")+
   ylim(0,11000)+
  ggtitle("Day 14, 30C");ALL_30_Day14plot_9000
```
...
ALL_30_Day14plot_9000<-ALL_30_Day14plot_9000+ theme(legend.position = "none") #remove legend  Note that at 31 most larvae are dead.
...
ALL_31_Day7plot_9000<-ggplot() + 
  geom_bar(aes(y = cells.larvae, x = ALL.number, fill = Symbiont), data = ALL_31_Day7_9000,
                           stat="identity")+
   ylim(0,3500)+
  ggtitle("Day 7, 31C");ALL_31_Day7plot_9000
```

Plot all two ALL 31C days together:
```{r}
ALL_31_Day3plot_9000<-ALL_31_Day3plot_9000+ theme(legend.position = "none") #remove legend 
#ALL_31_Day7plot_9000<-ALL_30_Day7plot_9000+ theme(legend.position = "none") #remove legend
 
grid.arrange(ALL_31_Day3plot_9000, ALL_31_Day7plot_9000,nrow = 1)
``` 

Plot all ALL cell counts all temps together 3x3
```{r}
grid.arrange(ALL_27_Day3plot_9000, ALL_27_Day7plot_9000, ALL_27_Day14plot_9000, ALL_30_Day3plot_9000, ALL_30_Day7plot_9000, ALL_30_Day14plot_9000,ALL_31_Day3plot_9000,ALL_31_Day7plot_9000,nrow = 3)
```
...
### do it again with log values
#Log raw means
D1Full$cells.larvae_log<-log(D1Full$cells.larvae+1)

D1Full_meanlog<- ddply(D1Full, c("Day", "Temp"), summarise, #summarize cell counts
...
D1Full_meanlog #display table


D1Full_log_plot_9000<-ggplot(data=D1Full_meanlog, aes(x=Day, y=mean, group = Temp, color=Temp)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Temp), size=4, show.legend = T)+
  geom_line(aes(color=Temp))+
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        plot.background =element_blank(), #Set the plot background
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("log"[10],"(cells/larvae)"))) +
  ggtitle("D1Full_log")+
  theme(plot.title = element_text(size=20, face = "italic"));D1Full_log_plot_9000
...
F1Full_meanlog<- ddply(F1Full, c("Day", "Temp"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
F1Full_meanlog #display table


F1Full_log_plot_9000<-ggplot(data=F1Full_meanlog, aes(x=Day, y=mean, group = Temp, color=Temp)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Temp), size=4, show.legend = T)+
  geom_line(aes(color=Temp))+
  ...
  ylab(expression(paste("log"[10],"(cells/larvae)"))) +
  ggtitle("F1Full_log")+
  theme(plot.title = element_text(size=20, face = "italic"));F1Full_log_plot_9000
...
G3Full_meanlog<- ddply(G3Full, c("Day", "Temp"), summarise, #summarize cell counts
                 N    = length(cells.larvae[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important*
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                 sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
G3Full_meanlog #display table


G3Full_log_plot_9000<-ggplot(data=G3Full_meanlog, aes(x=Day, y=mean, group = Temp, color=Temp)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Temp), size=4, show.legend = T)+
  geom_line(aes(color=Temp))+
  ...
  ylab(expression(paste("log"[10],"(cells/larvae)"))) +
  ggtitle("G3Full_log")+
  theme(plot.title = element_text(size=20, face = "italic"));G3Full_log_plot_9000
``` 
...
#logs (remove the 'log' to print non logscale)
C1Full_log_plot_9000<-C1Full_log_plot_9000+ theme(legend.position = "none") #remove legend
D1Full_log_plot_9000<-D1Full_log_plot_9000+ theme(legend.position = "none") #remove legend
F1Full_log_plot_9000<-F1Full_log_plot_9000+ theme(legend.position = "none") #remove legend
#G3_plot_9000<-G3_plot_9000+ theme(legend.position = "none") #remove legend

grid.arrange(C1Full_log_plot_9000, D1Full_log_plot_9000, F1Full_log_plot_9000,G3Full_log_plot_9000, nrow = 2)
```



##Make Relative Abundance dataframe, rerun plots of infection with RA, ddPCR
```{r}
#ALLS, ddPCR
...
ALL High 30C
```{r}
ALL_30_mean_9000 <- ddply(ALL_30_9000, c("Day", "Temp","Symbiont"), summarise, #summarize cell count
                 N    = length(cells.larvae[!is.na(cells.larvae)]), #calculate the length of the data frame, excluding NA’s *this part is important* 
                 mean = mean(cells.larvae, na.rm=TRUE), #calculate mean of response variable, removing NA's
                  sd   = sd(cells.larvae, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
```{r}
C1_27C_multi<-subset(ALL_27_9000, Symbiont=="C1")
D1_27C_multi<-subset(ALL_27_9000, Symbiont=="D1")
F1_27C_multi<-subset(ALL_27_9000, Symbiont=="F1")
G3_27C_multi<-subset(ALL_27_9000, Symbiont=="G3")

C1_30C_multi<-subset(ALL_30_9000, Symbiont=="C1")
D1_30C_multi<-subset(ALL_30_9000, Symbiont=="D1")
F1_30C_multi<-subset(ALL_30_9000, Symbiont=="F1")
G3_30C_multi<-subset(ALL_30_9000, Symbiont=="G3")

C1_31C_multi<-subset(ALL_31_9000, Symbiont=="C1")
D1_31C_multi<-subset(ALL_31_9000, Symbiont=="D1")
F1_31C_multi<-subset(ALL_31_9000, Symbiont=="F1")
G3_31C_multi<-subset(ALL_31_9000, Symbiont=="G3")
...
ALLcast_9000_cast3<-ALLcast_9000_cast2 #copy df
