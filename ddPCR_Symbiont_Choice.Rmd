...
InitaialInfect<-rbind(Initial_C1,Initial_D1,Initial_F1,Initial_G3)     # combine 

#by temp
InitaialInfect_27<-subset(InitaialInfect, Temp=="27")
InitaialInfect_30<-subset(InitaialInfect, Temp=="30")
InitaialInfect_31<-subset(InitaialInfect, Temp=="31")

#means
#All temps
InitaialInfect_mean <- ddply(InitaialInfect, c("Symbiont", "Temp"), summarise, #summarize cell counts
...
InitaialInfect_mean #display table 

#plot all temps
InitaialInfect_all_plot<-ggplot(data=InitaialInfect_mean, aes(x=Temp, y=mean, group = Symbiont, color=Symbiont)) +
  ...
  ggtitle("Cell counts infect")+
  theme(plot.title = element_text(size=20, face = "italic"));InitaialInfect_all_plot
