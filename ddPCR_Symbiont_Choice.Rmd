...
#test F1 using the logged column
F1mod2<-lmer(cells.larvae_log~Day*Temp+(1|Pot), F1Full)
summary(F1mod2)
  qqPlot(residuals(F1mod2)) #not amazing but not entirely awful
#conduct post hoc test
emm_F1mod2 = emmeans(F1mod2, ~ Day*Temp, adjust="tukey")
cld(emm_F1mod2, Letters=c(LETTERS)) #letter display
...
*** this is where you are. C1 not lining up. 
