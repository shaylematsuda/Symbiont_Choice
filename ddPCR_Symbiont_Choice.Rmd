...
plot_9000<-ggplot(data=ALL_31_mean_9000, aes(x=Day, y=mean, group = Symbiont, color=Symbiont)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Symbiont), size=4, show.legend = T)+
  geom_line(aes(color=Symbiont))+
...
#plot comparisons by dat
#Day3
C1Full_mean_Day3<-subset(C1Full_mean, Day=="3")
C1Full_mean_Day3plot<-ggplot(data=C1Full_mean_Day3,aes(x=code, y=mean, fill=count.type)) +
  geom_bar(stat="identity");C1Full_mean_Day3plot

#Day7
C1Full_mean_Day7<-subset(C1Full_mean, Day=="7")
C1Full_mean_Day7plot<-ggplot(data=C1Full_mean_Day7,aes(x=code, y=mean, fill=count.type)) +
  geom_bar(stat="identity");C1Full_mean_Day7plot

C1Full_mean_Day14<-subset(C1Full_mean, Day=="14")
C1Full_mean_Day14plot<-ggplot(data=C1Full_mean_Day14,aes(x=code, y=mean, fill=count.type)) +
  geom_bar(stat="identity");C1Full_mean_Day14plot
#### you are missing day 14 HEMO counts! 
