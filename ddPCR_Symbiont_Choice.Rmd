...
ALLcast_9000_cast2a_NMDS<-ALLcast_9000_cast2a
ALLcast_9000_cast2a_NMDS<-na.omit(ALLcast_9000_cast2a_NMDS)
ALLcast_9000_cast2a_NMDS<-subset(ALLcast_9000_cast2a_NMDS, select=-c(C1_round,D1_round,F1_round,G3_round))
#removerows with 0s all across
#ALLcast_9000_cast2a_NMDS<-ALLcast_9000_cast2a_NMDS[-c(8),]

ALLcast_9000_cast2a_NMDS<-ALLcast_9000_cast2a_NMDS[ALLcast_9000_cast2a_NMDS$ALL.number != "105" & ALLcast_9000_cast2a_NMDS$ALL.number != "134"& ALLcast_9000_cast2a_NMDS$ALL.number != "156"& ALLcast_9000_cast2a_NMDS$ALL.number != "195"& ALLcast_9000_cast2a_NMDS$ALL.number != "200", ] 

#make community matrix - extract columns with abundance information
com = ALLcast_9000_cast2a_NMDS[,5:ncol(ALLcast_9000_cast2a_NMDS)]
...
data.scores$ALL.number = ALLcast_9000_cast2a_NMDS$ALL.number
data.scores$Temp = ALLcast_9000_cast2a_NMDS$Temp
data.scores$Day = ALLcast_9000_cast2a_NMDS$Day
 
head(data.scores)
#write.csv(data.scores, "data.scores.csv")
#write.csv(ALLcast_9000_cast2a_NMDS, "ALLcast_9000_cast2a_NMDS.csv")
...
xx = ggplot(data.scores, aes(x = NMDS1, y = NMDS2)) + 
  ...
  stat_ellipse(aes(x=NMDS1, y=NMDS2,color=Temp)) 
