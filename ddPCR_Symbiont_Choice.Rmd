...
C1Full_meanlog<- ddply(C1Full, c("Day", "Temp"), summarise, #summarize cell counts
...
C1Full_meanlog #display table


C1Full_log_plot_9000<-ggplot(data=C1Full_meanlog, aes(x=Day, y=mean, group = Temp, color=Temp)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Temp), size=4, show.legend = T)+
  geom_line(aes(color=Temp))+
  ...
  ggtitle("C1Full_log")+
  theme(plot.title = element_text(size=20, face = "italic"));C1Full_log_plot_9000
```
...
ALL_RelA_b<-melt(ALL_RelA_a, id=c("Day", "Temp", "ALL.number"), measure.vars = c("Cladocopoium","Durusdinium","Fugacium" ,"Gerakladium"))
...
ALL_RAW_31<-ggplot(ALL_31_mean_9000, aes(y=mean1, x=Day, fill=Symbiont, label=mean1)) + 
           geom_bar(stat="identity")+
            geom_text(size=10, position=position_stack(vjust = 0.5))+
            scale_fill_locuszoom()+
   xlab("Day")+
...
grid.arrange(ALL_RAW_27, ALL_RAW_30, ALL_RAW_31,ALL_STP_27, ALL_STP_30, ALL_STP_31, nrow = 2)
...
emmeans(MULTImod, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
```
...
emmeans(AllmodDay3, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
emmeans(AllDay7, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
C1ALLvars<-c("Temp","Day", "Primer", "Pot", "Replicate","cells.larvae","single.multi","cells.larvae_log")
...
anova(C1_EOmodD3)
emmeans(C1_EOmodD3, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
anova(C1_EOmodD7)
emmeans(C1_EOmodD7, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
anova(C1_EOmodD14)
emmeans(C1_EOmodD14, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
D1ALLvars<-c("Temp","Day", "Primer", "Pot", "Replicate","cells.larvae","single.multi","cells.larvae_log")
...
F1_EO.D3_plot<-ggplot(data=F1_EO.D3mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("Cells/Larvae"))) +
  ggtitle("F1_27C_Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));F1_EO.D3_plot
...
anova(F1_EOmodD7)
emmeans(F1_EOmodD7, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
F1_EO.D7_plot<-ggplot(data=F1_EO.D7mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("F1_Day7 Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));F1_EO.D7_plot
...
anova(F1_EOmodD14)
emmeans(F1_EOmodD14, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
F1_EO.D14_plot<-ggplot(data=F1_EO.D14mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("F1_Day14 Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));F1_EO.D14_plot
```
...
anova(G3_EOmod)
emmeans(G3_EOmod, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
G3_EO.D3_plot<-ggplot(data=G3_EO.D3mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("Cells/Larvae"))) +
  ggtitle("G3_27C_Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));G3_EO.D3_plot
```
...
anova(G3_EOmodD7)
emmeans(G3_EOmodD7, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
G3_EO.D7_plot<-ggplot(data=G3_EO.D7mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("G3_Day7 Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));G3_EO.D7_plot
```
...
anova(G3_EOmodD14)
emmeans(G3_EOmodD14, pairwise ~ Temp |Day)
cld(test, Letters=c(LETTERS)) #letter display
...
G3_EO.D14_plot<-ggplot(data=G3_EO.D14mean, aes(x=single.multi, y=mean, group = Temp, color=Temp)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste("cells/larvae"))) +
  ggtitle("G3_Day14 Expected vs Observed")+
  theme(plot.title = element_text(size=20, face = "italic"));G3_EO.D14_plot
```
