...
#by Temp
ggplot(ALLdata_Day3.nmds_xy, aes(MDS1, MDS2, color = Temp)) + geom_point() + theme_bw()+  geom_polygon(data=ALLdata_Day3.nmds_xy,aes(x=MDS1,y=MDS2,fill=Temp,group=Temp),alpha=0.30)  # add the convex hulls

ordiplot(ALLdata_Day3.nmds, type = "n", main = "hulls")
orditorp(ALLdata_Day3.nmds_xy, display = "sites", labels = F, pch = c(16, 8, 17, 18) [as.numeric(ALLdata_Day3.nmds_xy$Temp)], col = c("green", "blue", "orange") [as.numeric(ALLdata_Day3.nmds_xy$Temp)], cex = 1)
ordihull(ALLdata_Day3.nmds_xy, groups = ALLdata_Day3.nmds_xy$Temp, draw = "polygon", lty = 1, col = "grey90")
