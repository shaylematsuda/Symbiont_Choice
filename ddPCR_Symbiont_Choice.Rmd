...
Mord.df2$PercentSurv_sqrt<-sqrt(Mord.df2$PercentSurv+1)
...
#post hoc
 emm<-emmeans(Mort.df2_mod,  ~ Symbiont, adjust="Tukey")
cld(emm, Letter="abcdefg")
pairs(emm)

#post hoc diff at each day
 emm<-emmeans(Mort.df2_mod,  ~ Temp|Symbiont, adjust="Tukey")
cld(emm, Letter="abcdefg")
pairs(emm)

 emm<-emmeans(Mort.df2_mod,  ~ Temp, adjust="Tukey")
cld(emm, Letter="abcdefg")
pairs(emm)
