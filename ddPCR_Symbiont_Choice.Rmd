...
## the elipse plot, you don't need but good to know how
ggplot(data=scopehemo_ddPCRCompare,aes(x=Countmean, y=ddPCRmean)) +
  ...
  #stat_ellipse(geom = "polygon", alpha = 1/4, level=0.5,aes(fill = Symbiont))+ # alpha lets you choose confidence interval
theme_classic()+
  geom_smooth(method=lm,se = FALSE, color="black")+ #lm
    geom_smooth(method=lm,se = FALSE, color="black")+ #lm forced through 0
