...
xx = ggplot(data.scores, aes(x = NMDS1, y = NMDS2)) + 
 ...
 stat_ellipse(geom = "polygon",level=.25, alpha = .2, aes(fill=Temp))+
  stat_ellipse(level=.25,  aes(x=NMDS1, y=NMDS2,color=Temp))
...
xday3 = ggplot(data.scores_d3, aes(x = NMDS1, y = NMDS2)) + 
    ...
    labs(x = "NMDS1", colour = "Temp", y = "NMDS2", shape = "Day")  + 
scale_fill_manual(values=Palette1) +  
  scale_colour_manual(values=Palette1)+  stat_ellipse(geom = "polygon",level=.25, alpha = .2, aes(fill=Temp))+
  stat_ellipse(level=.25,  aes(x=NMDS1, y=NMDS2,color=Temp))
xday3
