...
Poly_no0<-rbind(Poly_Mono,PolyFull_no0)  ####THis is the df for Cell Densities! 20200822
hist(Poly_no0$cells.larvae_log) # normal 

#rename Pot interaction as a code: Pot_Temp
 Poly_no0$PotCode<-paste0(Poly_no0$Temp, Poly_no0$Pot,Poly_no0$Symbiont )
 Poly_no0$PotCode<-as.factor(Poly_no0$PotCode) #make factor

#Full model    
Poly_no0$daytemp<-paste0(Poly_no0$Day, Poly_no0$Temp )  #create tag
Poly_no0_NOD1431C<-subset(Poly_no0, daytemp !=1431)       #remove 1431


## lmer  symbionts*days*temp
Counts_no0_all_mod_noD1431<-lmer(cells.larvae_log~Symbiont*Day*Temp+(1|PotCode), Poly_no0_NOD1431C)
