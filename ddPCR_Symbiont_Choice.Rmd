...
#ALL
ALL_vars<-c("Temp","Day", "Info","Pot","cells.larvae")
ALL_9000b<-ALL_9000b[ALL_vars]
colnames(ALL_9000b)[colnames(ALL_9000b)=="Info"] <- "Symbiont"
ALL_9000b$count.type<-"ddPCR"
hist(ALL_9000b$cells.larvae)
#ALL_9000b$cells.larvae_log<-log(ALL_9000b$cells.larvae+1)
#  hist(ALL_9000b$cells.larvae_log, w=.01, breaks = 10) 

#organize hemo data
ALLcountdat<-subset(Countdat_2, Symbiont=="ALL")
ALLFull<-rbind(ALL_9000b,ALLcountdat) #combine hemo and ddPCR
hist(ALLFull$cells.larvae) 
ALLFull$cells.larvae_log<-log10(ALLFull$cells.larvae+1)
hist(ALLFull$cells.larvae_log) 
...
#remove means groups without n=3
scopehemoFull_mean2<-subset(scopehemoFull_mean2, N=="3")

# raw means for ddPCR  only
ddPCRcompare<-rbind(C1_9000b,D1_9000b,F1_9000b,G3_9000b,ALL_9000b)
#Raw means
...
ddPCRcompare_mean2<-subset(ddPCRcompare_mean2, N=="3")
...
#CN mod, force through origin
#CountsMOD2<-lm(ddPCRmean_log ~ 0 + Countmean_log+Countmean_log:count.type.x,data = scopehemo_ddPCRCompare)
#anova(CountsMOD2)
#summary(CountsMOD2)

#CountsMOD3<-lm(ddPCRmean_log ~ 0 + Countmean_log:count.type.x + Countmean_log,data = scopehemo_ddPCRCompare)
#anova(CountsMOD3)
#summary(CountsMOD3)
...
# Monoculture infection: Cell Counts Models and Plots (updated 20200822)
...
###this still contains data for day 14 for C, All, F, and G. You prob want to remove that. you try this below in next section:  
...
CountsCompare2_C1_31<-subset(CountsCompare2_mean_31, Symbiont=="C1")
 CountsCompare2_C1_31<-subset(CountsCompare2_C1_31, Day=="3" |Day=="7")
...
CountsCompare2_C1_plot31<-ggplot(data=CountsCompare2_C1_31, aes(x=Day, y=mean, group=single.multi,color=single.multi)) +
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  ylab(expression(paste(""))) +
  ggtitle("31C do you want to remove d7")+
...
CountsCompare2_ALL_mod<-lmer(cells.larvae_log~Temp*Day*single.multi*Symbiont+(1|PotCode),CountsCompare2_NoD1431C)
...
``` 
C1, full mod, then by temp   <- cut all the individual genus mods
```{r}    
#C1    
#full 
...
qqPlot(residuals(CountsCompare2_C1_mod_27))   # good
   emm<-emmeans(CountsCompare2_C1_mod_27,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
...
qqPlot(residuals(CountsCompare2_C1_mod_30))   # good
   emm<-emmeans(CountsCompare2_C1_mod_30,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
...
qqPlot(residuals(CountsCompare2_C1_mod_31))   # good
   emm<-emmeans(CountsCompare2_C1_mod_31,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
...
qqPlot(residuals(CountsCompare2_G3_mod_27))   # good
   emm<-emmeans(CountsCompare2_G3_mod_27,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
...
qqPlot(residuals(CountsCompare2_G3_mod_30))   # good
   emm<-emmeans(CountsCompare2_G3_mod_30,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
...
qqPlot(residuals(CountsCompare2_G3_mod_31))   # good
   emm<-emmeans(CountsCompare2_G3_mod_31,  ~ single.multi|Temp|Day, adjust="Tukey") 
cld(emm)
pairs(emm)
