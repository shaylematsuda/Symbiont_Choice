...
```{r}    
#Singel vs Multi 
#######################################NOT WORKING WHY ALL THE OTHERS WORK
...
CELL DENSITY
## Polyculture: Individual clade heatmaps, Poly INFECTION counts not relabund (with 0s for individual clades) 
...
START HERE IN MORNING: Check dataframe building. 
...
ALL_forCounts$Symbiont<-"Poly" #add symbiont col
...
PolyFull_no0<-subset(ALL_forCounts, cells.larvae>0)
