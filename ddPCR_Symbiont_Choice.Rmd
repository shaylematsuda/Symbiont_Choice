...
## WORKING ON - how to do ANCOVA with model2  <- AH 



#last test: ddpcrmean_log~countmean_log+countmean_log:count.type.x
#nonsignificant effect of count.type.x on the relationship between ddpcrmean_log and countmean_log
scopehemo_ddPCRCompare$count.type.x<-as.factor(scopehemo_ddPCRCompare$count.type.x)
lmodel2(ddPCRmean_log~Countmean_log+Countmean_log:count.type.x, data = scopehemo_ddPCRCompare)
```
...
#PLOT SINGLE INFECTIONS (count data) CUT THIS OUT  
...
https://sebastianraschka.com/Articles/heatmaps_in_r.html
 ...
 Individual clade heatmaps SINGLE INFECTION,  0s REMOVED
```{r} 
hist(Singles_C1$cells.larvae_log)
hist(Singles_D1$cells.larvae_log)
hist(Singles_F1$cells.larvae_log)
hist(Singles_G3$cells.larvae_log)
...
```
Individual clades heatmaps SINGLE, C1Full 0s NOT REMOVED C1Full, D1Full, F1Full, G3Full
```{r} 
...
#A. Binomial. Did larvae infect or not, by clade and overall. Plots and comparison models singe v multi
```{r}    
...
####Individual Infections of MULTI larvae
C1 -single alone  
```{r}     
...
#save
ggsave(filename="Figures/BinaryInfect_Figb.png", plot=BinaryInfect_Figb, dpi=300, width=12, height=12, units="in")
```
...
NumClades_27_D3_waffle <- c(One=5, Two=7, Three=39, Four=49)
 NumClades_27_D3_wafflePLOT<-waffle(NumClades_27_D3_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_27_D3_wafflePLOT
 	
 #27 D7
NumClades_27_D7<-subset(NumClades_27, Day==7)
NumClades_27_D7_waffle <- c(One=4, Two=4, Three=26, Four=66)
 NumClades_27_D7_wafflePLOT<-waffle(NumClades_27_D7_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858")); NumClades_27_D7_wafflePLOT 
 
 
  #27 D14
NumClades_27_D14<-subset(NumClades_27, Day==14)
NumClades_27_D14_waffle <- c(One=4, Two=4, Three=27, Four=65)
 NumClades_27_D14_wafflePLOT<-waffle(NumClades_27_D14_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_27_D14_wafflePLOT
...
NumClades_30_D3_waffle <- c(One=5, Two=30, Three=46, Four=19)
 NumClades_30_D3_wafflePLOT<-waffle(NumClades_30_D3_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_30_D3_wafflePLOT
 	
 #30 D7
NumClades_30_D7<-subset(NumClades_30, Day==7)
NumClades_30_D7_waffle <- c(One=7, Two=7, Three=26, Four=60)
 NumClades_30_D7_wafflePLOT<-waffle(NumClades_30_D7_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_30_D7_wafflePLOT
 
  #30 D14
NumClades_30_D14<-subset(NumClades_30, Day==14)
NumClades_30_D14_waffle <- c(One=0, Two=7, Three=57, Four=36)
 NumClades_30_D14_wafflePLOT<-waffle(NumClades_30_D14_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_30_D14_wafflePLOT
...
NumClades_31_D3_waffle <- c(One=11, Two=22, Three=42, Four=25)
 NumClades_31_D3_wafflePLOT<-waffle(NumClades_31_D3_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_31_D3_wafflePLOT
 	
 #31 D7
NumClades_31_D7<-subset(NumClades_31, Day==7)
NumClades_31_D7_waffle <- c(One=0, Two=29, Three=57, Four=14)
 NumClades_31_D7_wafflePLOT<-waffle(NumClades_31_D7_waffle, rows=5, colors=c("#ECE7F2", "#A6BDDB" ,"#0570B0", "#023858"));NumClades_31_D7_wafflePLOT
...
## Individual clade heatmaps MUTLI INFECTION counts not relabund (with 0s for individual clades)
...
## Individual clade heatmaps MUTLI INFECTION counts not relabund (with 0s for individual clades REMOVED!!!)
MultiCounts2=df (multi including all samples that amped (not trimmed))
```{r}
MultiCounts3<-subset(MultiCounts2, cells.larvae_round>0)   #subset only infected
```
...
#C1
#Singles_C1
MultiCounts3_C1<-subset(MultiCounts3, Symbiont=="C1")
MultiCounts3_C1<-na.omit(MultiCounts3_C1)
hist(MultiCounts3_C1$cells.larvae_round)
MultiCounts3_C1$cells.larvae_log<-log10(MultiCounts3_C1$cells.larvae_round+1)
hist(MultiCounts3_C1$cells.larvae_log)


MultiCounts3_C1_mean <- ddply(MultiCounts3_C1, c("Temp","Day"), summarise, #summarize cell count
                 N    = length(cells.larvae_log[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important* 
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                  sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
MultiCounts3_C1_mean #display table
MultiCounts3_C1_mean$mean<-round(MultiCounts3_C1_mean$mean, digits = 2) #round the means

  MultiCounts3_C1_vars<-c("Temp","Day","mean")
MultiCounts3_C1_mean2<-MultiCounts3_C1_mean[MultiCounts3_C1_vars] 
MultiCounts3_C1_mean3<-cast(MultiCounts3_C1_mean2, Temp~Day, mean) #set updata for heatmap

C1rnames3 <- MultiCounts3_C1_mean3[,1]                            # assign labels in column 1 to "rnames"
C1mat_data3 <- data.matrix(MultiCounts3_C1_mean3[,2:ncol(MultiCounts3_C1_mean3)])  # transform column 2-5 into a matrix
rownames(C1mat_data3) <- C1rnames3                  # assign row names
...
C1heatMult_No0<-heatmap.2(C1mat_data3,
  cellnote = C1mat_data3,  # same data set for cell labels
  main = "C1", # heat map title
  notecol="black",      # change font color of cell labels to black
  density.info="none",  # turns off density plot inside color legend
  trace="none",         # turns off trace lines inside the heat map
...
#D1
#Singles_D1
MultiCounts3_D1<-subset(MultiCounts3, Symbiont=="D1")
MultiCounts3_D1<-na.omit(MultiCounts3_D1)
hist(MultiCounts3_D1$cells.larvae_round)
MultiCounts3_D1$cells.larvae_log<-log10(MultiCounts3_D1$cells.larvae_round+1)
hist(MultiCounts3_D1$cells.larvae_log)


MultiCounts3_D1_mean <- ddply(MultiCounts3_D1, c("Temp","Day"), summarise, #summarize cell count
                 N    = length(cells.larvae_log[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important* 
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                  sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
MultiCounts3_D1_mean #display table
MultiCounts3_D1_mean$mean<-round(MultiCounts3_D1_mean$mean, digits = 2) #round the means

  MultiCounts3_D1_vars<-c("Temp","Day","mean")
MultiCounts3_D1_mean2<-MultiCounts3_D1_mean[MultiCounts3_D1_vars] 
MultiCounts3_D1_mean3<-cast(MultiCounts3_D1_mean2, Temp~Day, mean) #set updata for heatmap

D1rnames3 <- MultiCounts3_D1_mean3[,1]                            # assign labels in column 1 to "rnames"
D1mat_data3 <- data.matrix(MultiCounts3_D1_mean3[,2:ncol(MultiCounts3_D1_mean3)])  # transform column 2-5 into a matrix
rownames(D1mat_data3) <- D1rnames3                 # assign row names
...
D1heatMult_no0<-heatmap.2(D1mat_data3,
  cellnote = D1mat_data3,  # same data set for cell labels
  main = "D1", # heat map title
  notecol="black",      # change font color of cell labels to black
  density.info="none",  # turns off density plot inside color legend
  trace="none",         # turns off trace lines inside the heat map
...
#F1
#Singles_F1
MultiCounts3_F1<-subset(MultiCounts3, Symbiont=="F1")
MultiCounts3_F1<-na.omit(MultiCounts3_F1)
hist(MultiCounts3_F1$cells.larvae_round)
MultiCounts3_F1$cells.larvae_log<-log10(MultiCounts3_F1$cells.larvae_round+1)
hist(MultiCounts3_F1$cells.larvae_log)


MultiCounts3_F1_mean <- ddply(MultiCounts3_F1, c("Temp","Day"), summarise, #summarize cell count
                 N    = length(cells.larvae_log[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important* 
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                  sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
MultiCounts3_F1_mean #display table
MultiCounts3_F1_mean$mean<-round(MultiCounts3_F1_mean$mean, digits = 2) #round the means

  MultiCounts3_F1_vars<-c("Temp","Day","mean")
MultiCounts3_F1_mean2<-MultiCounts3_F1_mean[MultiCounts3_F1_vars] 
MultiCounts3_F1_mean3<-cast(MultiCounts3_F1_mean2, Temp~Day, mean) #set updata for heatmap

F1rnames3 <- MultiCounts3_F1_mean3[,1]                            # assign labels in column 1 to "rnames"
F1mat_data3 <- data.matrix(MultiCounts3_F1_mean3[,2:ncol(MultiCounts3_F1_mean3)])  # transform column 2-5 into a matrix
rownames(F1mat_data3) <- F1rnames3                 # assign row names
...
F1heatMult_no0<-heatmap.2(F1mat_data3,
  cellnote = F1mat_data3,  # same data set for cell labels
  main = "F1", # heat map title
  notecol="black",      # change font color of cell labels to black
  density.info="none",  # turns off density plot inside color legend
  trace="none",         # turns off trace lines inside the heat map
...
#G3
#Singles_G3
MultiCounts3_G3<-subset(MultiCounts3, Symbiont=="G3")
MultiCounts3_G3<-na.omit(MultiCounts3_G3)
hist(MultiCounts3_G3$cells.larvae_round)
MultiCounts3_G3$cells.larvae_log<-log10(MultiCounts3_G3$cells.larvae_round+1)
hist(MultiCounts3_G3$cells.larvae_log)


MultiCounts3_G3_mean <- ddply(MultiCounts3_G3, c("Temp","Day"), summarise, #summarize cell count
                 N    = length(cells.larvae_log[!is.na(cells.larvae_log)]), #calculate the length of the data frame, excluding NA’s *this part is important* 
                 mean = mean(cells.larvae_log, na.rm=TRUE), #calculate mean of response variable, removing NA's
                  sd   = sd(cells.larvae_log, na.rm=TRUE), #calculate standard deviation
                 se   = sd / sqrt(N), #calculate standard error
...
MultiCounts3_G3_mean #display table
MultiCounts3_G3_mean$mean<-round(MultiCounts3_G3_mean$mean, digits = 2) #round the means

  MultiCounts3_G3_vars<-c("Temp","Day","mean")
MultiCounts3_G3_mean2<-MultiCounts3_G3_mean[MultiCounts3_G3_vars] 
MultiCounts3_G3_mean3<-cast(MultiCounts3_G3_mean2, Temp~Day, mean) #set updata for heatmap

G3rnames3 <- MultiCounts3_G3_mean3[,1]                            # assign labels in column 1 to "rnames"
G3mat_data3 <- data.matrix(MultiCounts3_G3_mean3[,2:ncol(MultiCounts3_G3_mean3)])  # transform column 2-5 into a matrix
rownames(G3mat_data3) <- G3rnames3                  # assign row names
...
G3heatMult_no0<-heatmap.2(G3mat_data3,
  cellnote = G3mat_data,  # same data set for cell labels
  main = "G3", # heat map title
  notecol="black",      # change font color of cell labels to black
  density.info="none",  # turns off density plot inside color legend
