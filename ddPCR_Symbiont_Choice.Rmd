...
#Single-genus infection: Models, log transformed
...
CompetitionSingle_27_mod<-lmer(cells.larvae_log~Day*Symbiont+(1|code),CompetitionSingle_27mod)
...
CompetitionSingle_30_mod<-lmer(cells.larvae_log~Day*Symbiont+(1|code),CompetitionSingle_30mod)
...
CompetitionSingle_31mod<-CompetitionSingle_31mod[!(CompetitionSingle_31mod$code2=="14_All_"),] #remove it
