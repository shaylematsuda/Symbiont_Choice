...
Hemocytometer and scope counts: For the single infection only, we did hemocytometer (hemo) and scope (larvae placed bewteen coverslip and slide) 3 reps/treatment pot. 
```{r}   
...
2.	Question: Does time or temperature effect the rate of how many larvae are infected by clade?
...
```{r}
#Subset 31
CountsCompare_G3<-subset(CountsCompare_mean_31, Symbiont=="G3")
